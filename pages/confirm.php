...
<html lang="en">
    ...
    <main class="d-flex flex-column align-items-center py-5 py-sm-0">
      ...
      <p class="color-text-primary text-center mb-5 fs-5 px-5" style="min-width: 50px; max-width: 600px;">Anda telah memilih kandidat - kandidat tersebut. Jika anda sudah yakin dengan pilihan anda, tekan tombol dibawah ini. Jika belum, tekan tombol kembali</p>
      <a href="../index.php" class="color-bg-primary text-light fw-bold py-2 px-5 rounded-2 text-decoration-none mb-2">Selesai & Log out</a>
      <a href="vote.php" class="color-text-primary">Kembali</a>
    </main>
